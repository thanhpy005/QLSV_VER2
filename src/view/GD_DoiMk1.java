...
public class GD_DoiMk1 extends javax.swing.JFrame implements ActionListener{
    public SinhVien sinhVien;
    public TaiKhoan taiKhoan;
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GD_DoiMk1.class.getName());
