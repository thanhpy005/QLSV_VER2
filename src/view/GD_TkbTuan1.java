...
public class GD_TkbTuan1 extends javax.swing.JFrame implements ActionListener{
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GD_TkbTuan1.class.getName());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(2)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    Name_ST2_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    Name_ST2_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST2_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST2_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT2_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT2_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT2_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT2_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(3)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    NAME_ST3_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST3_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST3_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST3_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT3_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT3_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT3_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT3_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(4)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    NAME_ST4_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST4_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST4_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST4_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT4_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT4_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT4_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT4_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(5)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    NAME_ST5_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST5_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST5_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST5_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT5_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT5_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT5_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT5_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(6)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    NAME_ST6_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST6_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST6_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST6_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT6_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT6_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT6_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT6_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
        ...
        for(LopHocPhan i : list)
        {
            if(i.getThu().equals(String.valueOf(7)))
            {
                if(i.getTietBatDau() == 1)
                {
                    ...
                    NAME_ST7_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST7_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 3)
                {
                    ...
                    NAME_ST7_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_ST7_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 7)
                {
                    ...
                    NAME_CT7_2T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT7_2T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                ...
                else if(i.getTietBatDau() == 9)
                {
                    ...
                    NAME_CT7_3T.setText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
                    NAME_CT7_3T.setToolTipText(new TkbDAO().getMonHoc(i.getMaGV(), s.getMajor()).getTenMon());
